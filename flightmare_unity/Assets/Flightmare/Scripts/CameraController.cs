  ...
  public class CameraController : MonoBehaviour
  {
      ...
      if (internal_state.readyToRender)
      {
        ...
        foreach (Vehicle_t vehicle_i in sub_message.vehicles)
        {
          foreach (Camera_t camera in vehicle_i.cameras)
          {
            ...
            Debug.Log(vehicle_i.position[0]);
            Debug.Log(vehicle_i.position[1]);
            Debug.Log(vehicle_i.position[2]);
            ...
            Debug.Log("Performed state update:");
            Debug.Log(vehicle_i.ID);
    ...
    */
    ...
    byte[] readImageFromHiddenCamera(Camera subcam, Camera_t cam_config)
    {
      ...
      // save image for debugging synchronisation between Unity and Flightmare
      /*
      var bytes = image.EncodeToPNG();
      string filename = "/home/simon/Documents/Meetings/week_25/debug_flightmare/unity/" + pub_message.frame_id + ".png";
